...
def output_filter(output: str, prompt_embedding: np.ndarray, threshold: float = 0.9, embedding_model: str = "text-embedding-ada-002"):
...
def main():
    ...
    filter_flag, similarity = output_filter(output, prompt_embedding)
    print(similarity)
    if filter_flag:
